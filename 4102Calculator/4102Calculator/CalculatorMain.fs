...
let main argv = 
    ...
    let disableOperationButtons() = 
        ...
        printfn "operation buttons disabled"
    ...
    //begin calling necessary methods
    formatDisplay
    formatButtons
    createNumButtonEvents
    createOperationButtonEvents
    createClearButtonEvents
